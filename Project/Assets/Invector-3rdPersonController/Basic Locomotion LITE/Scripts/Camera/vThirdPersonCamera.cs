...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    void CameraMovement()
    {
        ...
        distance = Mathf.Lerp(distance, defaultDistance, smoothFollow * Time.unscaledDeltaTime);
        //_camera.fieldOfView = fov;
        cullingDistance = Mathf.Lerp(cullingDistance, distance, Time.unscaledDeltaTime);
        ...
        targetLookAt.rotation = Quaternion.Slerp(targetLookAt.rotation, newRot, smoothCameraRotation * Time.unscaledDeltaTime);
